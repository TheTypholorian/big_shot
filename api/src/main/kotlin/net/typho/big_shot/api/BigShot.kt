...
import net.typho.big_shot.api.transform.RemapEvent
...
import net.typho.big_shot.api.transform.impl.BuiltinClassTweakerTransform
import net.typho.big_shot.api.transform.impl.ButIWantThatInMyMixinPackageTransform
import net.typho.big_shot.api.transform.impl.InjectMixinUtilsTransform
import net.typho.big_shot.api.transform.impl.RemapTransform
...
object BigShot {
    ...
    @get:JvmName("getApiPath")
    lateinit var API_PATH: Path
    @JvmField
    ...
    @JvmStatic
    fun onLoaderInit() {
        println("yay api init! $INSTRUMENTATION")
    }
}